(() => {
	...
	var _n =
		...
		de = class {
			constructor(e) {
				(this.options = e),
					(this._listeners =
						"WeakMap" in _n ? new WeakMap() : void 0);
			}
			observe(e, t) {
				return (
					...
					: (this._observer = new ResizeObserver((t) => {
							...
							for (let l of t)
								de.entries.set(l.target, l),
									(s = this._listeners.get(l.target)) ===
										null ||
										s === void 0 ||
										s(l);
						}));
			...
			((h.ctx = t
				? t(n, e.props || {}, (m, p, ...d) => {
						...
						return (
							h.ctx &&
								l(h.ctx[m], (h.ctx[m] = _)) &&
								(!h.skip_bound && h.bound[m] && h.bound[m](_),
								c && vs(n, m)),
							p
						);
					})
	...
	function Ln(n, e, t) {
		let s = n.slice();
		return (
			(s[10] = e[t][0]), (s[11] = e[t][1]), (s[12] = e), (s[13] = t), s
		);
	}
	function qn(n, e, t) {
		let s = n.slice();
		return (
			(s[14] = e[t][0]), (s[15] = e[t][1]), (s[16] = e), (s[17] = t), s
		);
	}
	function Bn(n) {
		let e,
		...
		return {
			c() {
				...
				(h = A()),
					...
					(e.open = c =
						n[7] || n[3].map(Jn).includes(n[10].toLowerCase()));
			},
			m(d, _) {
				y(d, e, _),
					b(e, t),
			...
			p(d, _) {
				...
				_ & 138 &&
					c !==
						(c =
							d[7] ||
							d[3].map(Jn).includes(d[10].toLowerCase())) &&
					(e.open = c);
			},
			d(d) {
				d && k(e), Q(p, d);
		...
		return (
			(n.$$set = (d) => {
				"available_filters" in d && t(1, (s = d.available_filters)),
					"show_empty_filters" in d &&
						t(2, (l = d.show_empty_filters)),
					"open_filters" in d && t(3, (r = d.open_filters)),
					"translate" in d && t(4, (i = d.translate)),
					"automatic_translations" in d &&
						t(5, (a = d.automatic_translations)),
			...
			p(R, M) {
				(!d ||
					...
					(!d || M[0] & 524416) &&
						...
						N(o, a),
					(!d || M[0] & 512) &&
						B(i, "pagefind-ui__suppressed", !R[9]),
					R[12]
						? f
